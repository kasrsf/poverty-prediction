...
from models import BaseModelWrapper, LightGBMModel, XGBoostModel, CatBoostModel
from ensemble import Ensemble, optimize_ensemble_weights
from poverty_rates import calculate_survey_rates, create_poverty_submission, QuantileCalibrator
...
def main(calibrate: bool = True, tag: str = ""):
    ...
    # Try to load ensemble, or train new models
    try:
        ensemble = Ensemble.load(MODELS_DIR / "ensemble.pkl")
...
if __name__ == "__main__":
    ...
    main(calibrate=not args.no_calibrate, tag=args.tag)
